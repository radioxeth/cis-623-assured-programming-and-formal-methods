--------------------------------------------------------------------------------
5.6.2  The Set Data Type

       Illustrate, how to implement selected set operations via  list 
       comprehensions (implemented in Set.lhs), import the module, and test the 
       results here.
...
Check if applying flatten to a set A, followed by makeSet
recovers the set A again.
