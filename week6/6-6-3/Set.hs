...
module Set ( Set ,
  ...
  card               , -- Set a -> Int
  flatten            , -- Set a -> [a]
prop_UniCommutative  , -- (Ord a => [a] -> [a] -> Bool) 
prop_UniAssociative    -- (Ord a => [a] -> [a] -> [a] -> Bool) 
  ) where
...
prop_UniCommutative xs ys = 
    (union (Set xs) (Set ys) == union (Set ys) (Set xs)) 

--        where types = (xs :: [Int], ys :: [Int])

prop_Wrong       :: [Int] -> [Int] -> Bool 
prop_Wrong xs ys =  
    (union (Set xs) (Set ys) == inter (Set ys) (Set xs))
...
prop_UniAssociative xs ys zs = 
    (union (union (Set xs) (Set ys)) (Set zs))  
    == 
    (union (Set xs) (union (Set ys) (Set zs))) 
...
flatten          :: Set a -> [a]   -- added to the original file
flatten (Set xs) =  xs
